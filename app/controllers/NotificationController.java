...
import com.arpnetworking.metrics.util.OrganizationProvider;
...
public class NotificationController extends Controller {
            ...
            if (!group.isPresent()) {
                ...
                if (!notificationGroup.getEntries().contains(notificationEntry)) {
                    ...
                    LOGGER.debug()
                            ...
                            .addData("organization", Organization.DEFAULT)
                            .log();
                }
            }
            // CHECKSTYLE.OFF: IllegalCatch - Convert any exception to 500
    ...
    public CompletionStage<Result> testNotification(final String emailAddress) {
        ...
        final DefaultAlert alert = new DefaultAlert.Builder()
                ...
                .build();
        final AlertTrigger trigger = new AlertTrigger.Builder()
